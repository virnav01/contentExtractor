...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .background-color {
      background-color: rgba(43, 5, 72, 1) !important;
    }
    ...
    .secondary-text-color {
      color: rgba(138, 124, 202, 1) !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="buttons-container">
		<a class="border-button" href="https://www.membershipdrive.tools/PDFExtractor/" target="_blank">Go To Homepage</a>
		<a class="border-button" href="mailto:viral.navadiya@kriit.com" target="_blank">Report A Problem</a>
	</div>
</div>
